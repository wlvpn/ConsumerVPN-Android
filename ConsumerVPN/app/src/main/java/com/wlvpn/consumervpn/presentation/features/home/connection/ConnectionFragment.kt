...
class ConnectionFragment : HomeViewPagerFragment<ConnectionContract.Presenter>(), ConnectionContract.View {
    ...
    override fun onCreateOptionsMenu(menu: Menu, inflater: MenuInflater) {
        inflater.inflate(R.menu.menu_home_connection, menu)
    }
    ...
    override fun showSettings() {
        featureNavigator.navigateToSettings()
    }
